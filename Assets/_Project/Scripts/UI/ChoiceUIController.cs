...
public class ChoiceUIController : MonoBehaviour
{
    ...
    /// Includes a delay after typewriter completes.
    /// </summary>
    public void ShowChoices(List<string> choiceTexts)
    {
        ...
        StartCoroutine(ShowChoicesWithDelay(choiceTexts));
    }

    /// <summary>
    /// Coroutine to show choices after a short delay.
    /// </summary>
    private IEnumerator ShowChoicesWithDelay(List<string> choiceTexts)
    {
